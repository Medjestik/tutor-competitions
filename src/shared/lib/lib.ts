export const SUPPORT_MAIL = 'mailto:contest@rut-miit.ru';

export const SOCIAL_TG = 'https://t.me/edtechmiit';
export const SOCIAL_MAX =
	'https://max.ru/join/0oA2yx1C9vKFN0-iKxoV-Y1dccthqSy7ZqeFFDPXMv0';
export const SOCIAL_MAX_CHAT =
